<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态：1可用 0维修中" prop="state">
        <el-input
          v-model="queryParams.state"
          placeholder="请输入状态：1可用 0维修中"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="vehicleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="载重" align="center" prop="capacity" />
      <el-table-column label="容积" align="center" prop="volume" />
      <el-table-column label="状态：1可用 0维修中" align="center" prop="state" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="载重" prop="capacity">
          <el-input v-model="form.capacity" placeholder="请输入载重" />
        </el-form-item>
        <el-form-item label="容积" prop="volume">
          <el-input v-model="form.volume" placeholder="请输入容积" />
        </el-form-item>
        <el-form-item label="状态：1可用 0维修中" prop="state">
          <el-input v-model="form.state" placeholder="请输入状态：1可用 0维修中" />
        </el-form-item>
      </el-form>
...
<script>
import { listVehicle, getVehicle, delVehicle, addVehicle, updateVehicle } from "@/api/LT/vehicle"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('LT/vehicle/export', {
        ...this.queryParams
